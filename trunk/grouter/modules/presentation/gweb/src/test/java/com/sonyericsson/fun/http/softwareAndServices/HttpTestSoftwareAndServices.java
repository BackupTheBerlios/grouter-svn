 ...
 */
package com.sonyericsson.fun.http.softwareAndServices;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class HttpTestSoftwareAndServices extends HttpUnitTestCase {
	...
	public void testSoftwareAndServicesMwml () throws MalformedURLException, IOException, SAXException, TransformerException {
		...
		assertNull(map.get("Wap configurator"));
	...
	public void testSoftwareAndServicesMxhtml() throws MalformedURLException, IOException, SAXException 
	{
		...
		assertNull(wap);
		assertNull(mms);
		WebLink ota = response.getLinkWithID("setup_configurator");
		assertNotNull(ota);
