insert into router (startedon, uptime, displayname, id) values ('2006-10-13 15:51:53', 100000000, 'ROUTER_TEST', 'rid_1');
...
insert into node (id, inbound_endpoint_fk, outbound_endpoint_fk, modifiedon, router_fk, displayname) values ('nid_1', 1,2,'2006-10-13 15:51:53', 'rid_1', 'FILE-TO-FILE1');
insert into node (id, inbound_endpoint_fk, outbound_endpoint_fk, modifiedon, router_fk, displayname) values ('nid_2', 3,4,'2006-10-14 15:51:53',  'rid_1', 'FILE-TO-FTP');
