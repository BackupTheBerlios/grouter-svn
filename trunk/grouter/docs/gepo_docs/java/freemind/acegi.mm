...
<node CREATED="1162818173990" ID="Freemind_Link_1279589576" MODIFIED="1162818176015" TEXT="HttpSessionContextIntegrationFilter keeps the contents of the SecurityContext between invocations inside a HTTP session."/>
</node>
...
<node CREATED="1162765017234" ID="Freemind_Link_1460747242" MODIFIED="1162816509176" TEXT="it delegates to an implementation of the AuthenticationDao &#xa;interface, which has a single method, loadUserByUsername"/>
